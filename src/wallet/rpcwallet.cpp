    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"setlabel",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("setlabel", "\"FdeDnzHyMSroQWo2uz7GzHQhHEvtZRojCY\" \"tabby\"")
            + HelpExampleRpc("setlabel", "\"FdeDnzHyMSroQWo2uz7GzHQhHEvtZRojCY\", \"tabby\"")
                },
            }.Check(request);
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "If 'label' is specified, assign address to that label.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of groestlcoin addresses or hex-encoded public keys",
                        {
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of groestlcoin addresses to filter",
                        {
            ...
            "]\n"
                ...
                RPCExamples{
                    HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"FdeDnzHyMSroQWo2uz7GzHQhHEvtZRojCY\\\",\\\"FdR1zXywoLbPrpi65ifZuBKG99ST37Hwkp\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"FdeDnzHyMSroQWo2uz7GzHQhHEvtZRojCY\\\",\\\"FdR1zXywoLbPrpi65ifZuBKG99ST37Hwkp\\\"]\"")
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getaddressinfo",
                ...
                "to be in the wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The groestlcoin address to get the information of."},
                },
                RPCResult{
            "{\n"
