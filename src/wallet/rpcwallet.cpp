        ...
        HELP_REQUIRING_PASSPHRASE,
            ...
            "       \"" + FeeModes("\"\n\"") + "\""},
                ...
                RPCExamples{
                    ...
                    "\nSend 0.1 GRS with a fee rate of 1 " + CURRENCY_ATOM + "/vB, subtract fee from amount, BIP125-replaceable, using positional arguments\n"
    ...
    return RPCHelpMan{"listtransactions",
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        ...
                        {
                            {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                            {RPCResult::Type::STR, "address", "The groestlcoin address of the transaction."},
...
static RPCHelpMan listsinceblock()
{
    return RPCHelpMan{"listsinceblock",
            ...
            + HelpExampleCli("listsinceblock", "\"00000000007a9bec3227d13d6e5a7565a4e56b92b1e3510af604dc6313713ebf\" 6")
            + HelpExampleRpc("listsinceblock", "\"00000000007a9bec3227d13d6e5a7565a4e56b92b1e3510af604dc6313713ebf\", 6")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan gettransaction()
{
    return RPCHelpMan{"gettransaction",
                ...
                RPCResult{
                    ...
                    TransactionDescriptionString()),
                    {
                        {RPCResult::Type::ARR, "details", "",
                        {
                            ...
                            {
                                {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                                {RPCResult::Type::STR, "address", "The groestlcoin address involved in the transaction."},
                                {RPCResult::Type::STR, "category", "The transaction category.\n"
                                    "\"send\"                  Transactions sent.\n"
                                    "\"receive\"               Non-coinbase transactions received.\n"
                                    "\"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
                ...
                RPCExamples{
                    HelpExampleCli("gettransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\"")
            + HelpExampleCli("gettransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\" true")
            + HelpExampleCli("gettransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\" false true")
            + HelpExampleRpc("gettransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
...
static RPCHelpMan abandontransaction()
{
    return RPCHelpMan{"abandontransaction",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("abandontransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\"")
            + HelpExampleRpc("abandontransaction", "\"0e94a1eb9c9a40c6526aca53ac0a57088486ce7c329ffd9ad9dedee79cd8082a\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
...
static RPCHelpMan listunspent()
{
    return RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "The groestlcoin addresses to filter",
                        {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                            ...
                            {"changeAddress", RPCArg::Type::STR, /* default */ "pool address", "The groestlcoin address to receive the change"},
        ...
        [want_psbt](const RPCHelpMan& self, const JSONRPCRequest& request) mutable -> UniValue
{
    ...
    if (pwallet->IsWalletFlagSet(WALLET_FLAG_DISABLE_PRIVATE_KEYS) && !want_psbt) {
        if (!pwallet->chain().rpcEnableDeprecated("bumpfee")) {
            throw JSONRPCError(RPC_METHOD_DEPRECATED, "Using bumpfee with wallets that have private keys disabled is deprecated. Use psbtbumpfee instead or restart groestlcoind with -deprecatedrpc=bumpfee. This functionality will be removed in 2.22");
        }
        want_psbt = true;
    }
...
static RPCHelpMan send()
{
    return RPCHelpMan{"send",
            ...
            {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                {
                    ...
                    {"change_address", RPCArg::Type::STR_HEX, /* default */ "pool address", "The groestlcoin address to receive the change"},
        ...
        "Send 0.2 GRS with a fee rate of 1 " + CURRENCY_ATOM + "/vB using positional arguments\n"
    ...
    return RPCHelpMan{"walletcreatefundedpsbt",
                ...
                "Implements the Creator and Updater roles.\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
                            {"add_inputs", RPCArg::Type::BOOL, /* default */ "false", "If inputs are specified, automatically include more if they are not enough."},
                            {"changeAddress", RPCArg::Type::STR_HEX, /* default */ "pool address", "The groestlcoin address to receive the change"},
                            {"changePosition", RPCArg::Type::NUM, /* default */ "random", "The index of the change output"},
                            {"change_type", RPCArg::Type::STR, /* default */ "set by -changetype", "The output type to use. Only valid if changeAddress is not specified. Options are \"legacy\", \"p2sh-segwit\", and \"bech32\"."},
                            {"includeWatching", RPCArg::Type::BOOL, /* default */ "true for watch-only wallets, otherwise false", "Also select inputs which are watch only"},
                            {"lockUnspents", RPCArg::Type::BOOL, /* default */ "false", "Lock selected unspent outputs"},
...
static RPCHelpMan upgradewallet()
{
    return RPCHelpMan{"upgradewallet",
        ...
        RPCExamples{
            HelpExampleCli("upgradewallet", "216300")
            + HelpExampleRpc("upgradewallet", "216300")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
