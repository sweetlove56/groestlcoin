...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-checkpoints", strprintf("Enable rejection of any forks from the known historical chain until block 2785000 (default: %u)", DEFAULT_CHECKPOINTS_ENABLED), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
...
/** Sanity checks
 *  Ensure that Groestlcoin is running in a usable environment with all
