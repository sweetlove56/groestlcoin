        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "groestlcoin address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of groestlcoin addresses",
                        {{RPCResult::Type::STR, "address", "groestlcoin address"}}},
                }},
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", "Average feerate (in gros per virtual byte)"},
                ...
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in gros per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", "Maximum feerate (in gros per virtual byte)"},
                ...
                {RPCResult::Type::NUM, "minfeerate", "Minimum feerate (in gros per virtual byte)"},
