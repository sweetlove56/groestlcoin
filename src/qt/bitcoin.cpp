...
{
    QMessageBox::critical(nullptr, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Groestlcoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6. Determine availability of data and blocks directory and parse groestlcoin.conf
