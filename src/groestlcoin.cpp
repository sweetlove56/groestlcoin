...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 0000000000000abf98908046db181c15e9604952ee61bdebf3599ddbf857e43a
            /* nTime    */ 1606293682,
            /* nTxCount */ 4415183,
            /* dTxRate  */ 0.01856615937761523,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 000000cd4a4bde646a3083be528a808e20bbee561b8c14808ffd832a2e532616
            /* nTime    */ 1606298658,
            /* nTxCount */ 1915564,
            /* dTxRate  */ 0.01756233296119625,
        };
    }
};
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("signet.groestlcoin.org");
        ...
        genesis = CreateGenesisBlock(1606082400, 1315346, 0x1e0fffff, 112, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000d6d4c4d0336a8ab7e2b836fd76c152f8b8a78094f1d140aa5306b0fe4eb"));
        assert(genesis.hashMerkleRoot == uint256S("0x3ce968df58f9c8a752306c4b7264afab93149dbc578bd08a42c446caaa6628bb"));
