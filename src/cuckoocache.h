...
private:
    ...
    {
        return {{(uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<0>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<1>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<2>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<3>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<4>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<5>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<6>(e) * (uint64_t)size) >> 32),
                 (uint32_t)(((uint64_t)hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<7>(e) * (uint64_t)size) >> 32)}};
    }
