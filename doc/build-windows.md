...
It's not possible to build the Groestlcoin Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the Groestlcoin Core source code).
