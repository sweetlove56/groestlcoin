Groestlcoin Core version 2.21.0 is now available from:
...
with the 22.0.0 release. This means that a compiler that supports C++17 will be
required to compile 22.0.0
