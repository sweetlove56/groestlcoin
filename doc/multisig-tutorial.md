...
for ((n=1;n<=3;n++))
do
 ./src/groestlcoin-cli -signet createwallet "participant_${n}"
done
```
...
```bash
./src/groestlcoin-cli -signet -named createwallet wallet_name="multisig_wallet_01" disable_private_keys=true blank=true
