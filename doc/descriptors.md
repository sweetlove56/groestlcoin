...
- Segwit addresses (bech32, of the form `grs1...` for mainnet or `tgrs1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Groestlcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
