...
```
$ groestlcoin-cli -named createwallet wallet_name="wallet-01" descriptors=true
```
...
```
$ groestlcoin-cli -named createwallet wallet_name="wallet-01" descriptors=true passphrase="passphrase"
```
