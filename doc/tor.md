...
knows when upgrading to Groestlcoin Core v22.0 and up that supports Tor v3 only.
...
and open port 1331 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
