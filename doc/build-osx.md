...
Library                                                                                               | Purpose          | Description
----------------------------------------------------------------------------------------------------- |------------------|----------------------
[berkeley-db@5.3](https://github.com/zeroc-ice/homebrew-tap/blob/master/Formula/berkeley-db%405.3.rb) | Berkeley DB      | Wallet storage (only needed when wallet enabled)
...
To enable legacy wallets, you must install `berkeley-db@5.3`.
To enable [descriptor wallets](https://github.com/groestlcoin/groestlcoin/blob/master/doc/descriptors.md), `sqlite` is required.
Skip `berkeley-db@5.3` if you intend to *exclusively* use descriptor wallets.

###### Legacy Wallet Support

`berkeley-db@5.3` is required to enable support for legacy wallets.
...
Groestlcoin Core includes a GUI built with the cross-platform Qt Framework.
...
You can deploy a `.dmg` containing the Groestlcoin Core application using `make deploy`.
...
If `berkeley-db@5.3` is installed, then legacy wallet support will be built.
If `berkeley-db@5.3` is not installed, then this will throw an error.
...
Groestlcoin Core should now be available at `./src/groestlcoind`.
If you compiled support for the GUI, it should be available at `./src/qt/groestlcoin-qt`.
