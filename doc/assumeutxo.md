...
**Failure consideration:** if groestlcoind unexpectedly halts after `m_stop_use` is set on
...
When groestlcoind initializes again, what began as the snapshot chainstate is now
