...
all : groestlcoin-2.21.0-win32.msi groestlcoin-2.21.0-win64.msi
...
groestlcoin-2.20.1-win32.msi : groestlcoin.wxs x86_R_St\groestlcoin-qt.exe
	candle.exe -o groestlcoin-x86.wixobj groestlcoin.wxs
	$(WIX_LINK)  -out $@ groestlcoin-x86.wixobj

groestlcoin-2.20.1-win64.msi : groestlcoin.wxs x64_R_St\groestlcoin-qt.exe
