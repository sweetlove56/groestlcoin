...
# Deterministically build Groestlcoin Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/groestlcoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/groestlcoin/' to
        #     '/home/satoshi/groestlcoin/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/groestlcoin
        #
        #                     maps our current working directory to /groestlcoin
        ...
        #     container so that we have something to build. '/groestlcoin' was
        #     chosen arbitrarily.
        #
        ...
        #
        #     When builds of the Guix environment itself (not Groestlcoin Core)
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /groestlcoin && bash contrib/guix/libexec/build.sh"
    )
